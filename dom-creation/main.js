...
function renderPokemon(pokemon) {
  ...
  var $pokemonCardTextCreate = document.createElement('div');
  ...
  $pokemonCardTextCreate.appendChild($h2);

  var $h3 = document.createElement('h3');
  var $h3Text = document.createTextNode(pokemon.number);
  $h3.appendChild($h3Text);
  $pokemonCardTextCreate.appendChild($h3);

  var $p = document.createElement('p');
  var $pText = document.createTextNode(pokemon.description);
  $p.appendChild($pText);
  $pokemonCardTextCreate.appendChild($p);

  return $columnThirdCreate;
}
